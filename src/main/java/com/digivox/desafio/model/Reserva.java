...
public class Reserva {
	...
	public Reserva (LocalDate data_inicial, LocalDate data_final, Cliente cliente, Livro livro) {
	...
	public Reserva (Long id,LocalDate data_inicial, LocalDate data_final, Cliente cliente, Livro livro) {
		this.id = id;
		this.data_inicial = data_inicial;
		this.data_final = data_final;
		this.cliente = cliente;
